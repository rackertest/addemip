...
#
  ...
  $ipfile_base = "ifcfg-em1:"; # Base filename for IP Config Files
  $devname = "em1:"; # Base device name for configure IP's
  $filelist = $ifcfg_dir . "ifcfg-em1" . " " . $ifcfg_dir . "ifcfg-em1:*";
  #
